...
public class PaginaPrincipalDocet extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagina_principal_docet);
    ...
    @Override
    // instanciacion del menu sobre la actividad
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.pagina_principal_docet, menu);

        return true;
    }

    @Override
    // funcion que controla la acion a tomar al presionar sobre un elemento del menu
    ...
    @Override
    // funcion que controla que accioin tomar al precionar sobre un elemento del menu
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.publicaciones) {
            ...
            i=new Intent(this, CalificaionesPadre.class);
            startActivity(i);
